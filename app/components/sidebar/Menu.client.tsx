      ...
      >
        <div className="h-12 flex items-center justify-between px-4 border-b border-gray-100 dark:border-gray-800/50 bg-gray-50/50 dark:bg-gray-900/50 rounded-tr-2xl">
          ...
          <div className="flex items-center gap-3">
            <HelpButton onClick={() => window.open('https://stackblitz-labs.github.io/brainiac/', '_blank')} />
          ...
          <div className="flex items-center justify-between border-t border-gray-200 dark:border-gray-800 px-4 py-3">
            ...
            <div className="flex items-center gap-2">
              <a
                href="/admin"
                title="Admin Panel"
                className="transition-all hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg p-2 flex items-center justify-center"
              >
                <div className="i-ph:gear text-lg text-gray-600 dark:text-gray-400"></div>
              </a>
            </div>
          </div>
        </div>
