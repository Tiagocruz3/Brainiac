      ...
      <DropdownMenu.Portal>
        ...
        >
          ...
          <DropdownMenu.Item
            ...
            onClick={() =>
              window.open('https://github.com/stackblitz-labs/brainiac/issues/new?template=bug_report.yml', '_blank')
            }
          >
          ...
          <DropdownMenu.Item
            ...
            onClick={() => window.open('https://stackblitz-labs.github.io/brainiac/', '_blank')}
          >
